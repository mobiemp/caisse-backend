...
if($total_remise_tva != 0){
    $cumul_tva = $total_tva8 + $total_tva2 + $total_tva1 + $total_tva0 + $total_remise_tva;
    $ca_ht += $total_remise_tva;
}
else{
    $cumul_tva = $total_tva8 + $total_tva2 + $total_tva1 + $total_tva0 ;
}
                            ...
                            <div class="card card-warning" id="stats">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border-bottom mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <p class="stats-montant"><?php echo $p_cheque_euro == "" ? "0.00" : $p_cheque_euro ?>
                                                €</p>
                                        </div>
                                    </div>
                                    <div class="row">
